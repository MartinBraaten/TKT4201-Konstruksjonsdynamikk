...
% f = 1.562;  % between
% f = 2.681;  % high
 f = 0.9291;  % first resonance
% f = 1.9039;  % second resonance
...
D1 = P(1)/K(1)*1/((1-Beta(1)^2)^2 + (2*xi(1)*Beta(1))^2);
...
y_p1 = D1*((1-Beta(1)^2)*sin(w_load*t) - 2*xi(1)*Beta(1)*cos(w_load*t));
...
xlabel('seconds');
ylabel('radians');
sgtitle('Resonance: second natural frequency');